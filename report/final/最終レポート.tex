...
\begin{figure}[H]
  \centering 
  \includegraphics[scale=0.25]{画像1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.25]{画像2.png}
  \caption{クラス1の単語数}
  \centering
  \includegraphics[scale=0.25]{画像3.png}
  \caption{クラス3の単語数}
\end{figure}
\newpage
